...
\DoxyCodeLine{    assert(\mbox{\hyperlink{namespacerah_aaf7abb6066c8adfe6959691c3a3ea4e2}{rah::all\_of}}(}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{    assert(\mbox{\hyperlink{namespacerah_a836c57da2bd108c491f3ba96786f6aa4}{rah::any\_of}}(}
...
\DoxyCodeLine{        assert(out == std::vector<int>(\{ 1, 2, 3 \}));}
\end{DoxyCodeInclude}
...
\DoxyCodeLine{        assert(\mbox{\hyperlink{namespacerah_a1d0f36ff683cedc9090956ea389b3312}{rah::copy}}(in, out) | \mbox{\hyperlink{namespacerah_abf321dffb33d6a2d752aa091fdba7bbf}{rah::equal}}(std::initializer\_list<int>(\{ 4, 5 \})));}
\DoxyCodeLine{        assert(out == (std::vector<int>\{ 1, 2, 3, 4, 5 \}));}
\end{DoxyCodeInclude}
...
\DoxyCodeLine{        std::vector<int> in\{ 1, 2, 3 \};}
\DoxyCodeLine{        std::vector<int> out\{ 0, 0, 0, 4, 5 \};}
\DoxyCodeLine{        assert((in | \mbox{\hyperlink{namespacerah_ad9c29fa208b4ab8bfb9c226a1f82b9a1}{rah::copy\_into}}(out) | \mbox{\hyperlink{namespacerah_abf321dffb33d6a2d752aa091fdba7bbf}{rah::equal}}(std::initializer\_list<int>(\{ 4, 5 \}))));}
\DoxyCodeLine{        assert(out == (std::vector<int>\{ 1, 2, 3, 4, 5 \}));}
\end{DoxyCodeInclude}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{    assert(not (\mbox{\hyperlink{namespacerah_a51feb1497566c28de396f50735fd259b}{rah::empty}}(std::vector<int>\{ 1, 2, 3 \})));}
\DoxyCodeLine{    assert(\mbox{\hyperlink{namespacerah_a51feb1497566c28de396f50735fd259b}{rah::empty}}(std::vector<int>()));}
\end{DoxyCodeInclude}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{    assert(not (std::vector<int>\{ 1, 2, 3 \} | \mbox{\hyperlink{namespacerah_a51feb1497566c28de396f50735fd259b}{rah::empty}}()));}
\DoxyCodeLine{    assert(std::vector<int>() | \mbox{\hyperlink{namespacerah_a51feb1497566c28de396f50735fd259b}{rah::empty}}());}
\end{DoxyCodeInclude}
...
\DoxyCodeLine{        std::vector<int> in2\{ 1, 2, 3 \};}
\DoxyCodeLine{        std::vector<int> in3\{ 11, 12, 13 \};}
\DoxyCodeLine{        assert(in1 | \mbox{\hyperlink{namespacerah_abf321dffb33d6a2d752aa091fdba7bbf}{rah::equal}}(in2));}
\DoxyCodeLine{        assert(not (in1 | \mbox{\hyperlink{namespacerah_abf321dffb33d6a2d752aa091fdba7bbf}{rah::equal}}(in3)));}
\end{DoxyCodeInclude}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{    assert((\mbox{\hyperlink{namespacerah_a2a3ff8b7f73d480ac0827f9a41a3c92a}{rah::none\_of}}(}
...
\DoxyCodeLine{        assert(out.str() == in);}
\end{DoxyCodeInclude}
